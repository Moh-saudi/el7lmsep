    ...
    <div className="text-center py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          مرحباً بك في لوحة تحكم الأهل
        </h1>
        <p className="text-xl text-gray-600 mb-8">
          متابعة تقدم طفلك والاشتراكات والتواصل
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
            <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
            <span className="text-gray-700">التواصل مع المدربين</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-pink-50 rounded-lg">
            <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
            <span className="text-gray-700">متابعة الجداول والمواعيد</span>
          </div>
        </div>
        
        <div className="bg-gradient-to-r from-pink-500 to-rose-600 text-white p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">ابدأ رحلتك مع طفلك اليوم</h2>
          <p className="text-lg mb-6">
            انضم إلى مجتمعنا وابدأ في تطوير مهارات طفلك
          </p>

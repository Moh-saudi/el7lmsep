    ...
    <div className="text-center py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          مرحباً بك في لوحة تحكم المسوق
        </h1>
        <p className="text-xl text-gray-600 mb-8">
          إدارة حملاتك التسويقية وتتبع أدائك مع العملاء
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg">
            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
            <span className="text-gray-700">إدارة الحملات التسويقية</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg">
            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
            <span className="text-gray-700">تتبع الأداء والإحصائيات</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg">
            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
            <span className="text-gray-700">إدارة العملاء والعلاقات</span>
          </div>
          <div className="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg">
            <div className="w-2 h-2 bg-indigo-500 rounded-full"></div>
            <span className="text-gray-700">التواصل مع العملاء</span>
          </div>
        </div>
        
        <div className="bg-gradient-to-r from-indigo-500 to-blue-600 text-white p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">ابدأ رحلتك التسويقية اليوم</h2>
          <p className="text-lg mb-6">
            انضم إلى مجتمعنا وابدأ في بناء حملات تسويقية ناجحة
          </p>

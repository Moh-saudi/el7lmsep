...
export default function BeOnV3AdminPage() {
  ...
  const testWhatsAppShareFixed = () => {
    ...
    const result = {
      success: true,
      message: `تم إنشاء رابط WhatsApp للاختبار: ${whatsappUrl}`,
  ...
  const testWhatsAppShare = () => {
    ...
    const result = {
      success: true,
      message: `تم إنشاء رابط WhatsApp: ${whatsappUrl}`,
  ...
  // اختبار WhatsApp (القديم - يرسل SMS)
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="mb-6 p-4 border border-yellow-200 bg-yellow-50 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div>
            <strong className="text-yellow-800">ملاحظة مهمة:</strong> BeOn V3 لا يدعم WhatsApp فعلياً. جميع طلبات WhatsApp يتم إرسالها كـ SMS.
          </div>
        </div>
      </div>

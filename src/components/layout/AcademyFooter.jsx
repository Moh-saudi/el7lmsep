    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-4 px-4 mt-auto" style={{ direction: 'rtl' }}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
        ...
        <div className="flex gap-6 text-sm">
          <Link href="/about" className="text-gray-500 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-300 transition-colors">
            من نحن
          </Link>
          <Link href="/contact" className="text-gray-500 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-300 transition-colors">
            اتصل بنا
          </Link>
          <Link href="/privacy" className="text-gray-500 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-300 transition-colors">
            الخصوصية
          </Link>
        </div>

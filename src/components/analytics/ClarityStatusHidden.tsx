...
/**
 * مكون مخفي لعرض حالة Microsoft Clarity
 * للاستخدام في التطوير والاختبار فقط
 */
const ClarityStatusHidden: React.FC = () => {
  ...
  // إخفاء المكون في جميع البيئات
  // يمكن إظهاره مؤقتاً للتطوير بتغيير return null إلى return (...)
  return null;

  // الكود التالي مخفي ولكن متاح للاستخدام المستقبلي
  return (
...
export default ClarityStatusHidden;

// scripts/test-user-subscription.js
console.log('🧪 اختبار حالة الاشتراك للمستخدم: 0555555555@hagzzgo.com');
console.log('========================================================\n');
...
console.log('\n🔍 التحليل:');
console.log('==========');
console.log('1. المشكلة قد تكون في عدم حفظ البيانات في قاعدة البيانات');
console.log('2. المشكلة قد تكون في عدم استخراج userId بشكل صحيح');
console.log('3. المشكلة قد تكون في عدم البحث في المجموعة الصحيحة');
console.log('4. المشكلة قد تكون في عدم تحديث معالج الـ callback');
...
console.log('✅ معلومات تشخيصية في الصفحة');
